...
/**
  ...
  */
class NGram[A](val trainingData:List[List[A]], val order:Int) {
    ...
    /**
      ...
      */
    def parseNgram(n:Int, text:List[A], chain:Map[List[A], List[A]] = Map.empty[List[A], List[A]] ):Map[List[A],List[A]] = {
    ...
    /**
      ...
      */
    def parseNgrams(n:Int, texts:List[List[A]]):Map[List[A], List[A]] = {
    ...
    /**
      ...
      * @return
      */
    def getTextFromStarter(lengthLimit:Int, starter:List[A], gram:Map[List[A],List[A]]):List[A] = {
    ...
    /**
      ...
      */
    def getStarterTextFromGram(gram:Map[List[A], List[A]]):List[A] = {
    ...
    /**
      ...
      * @return
      */
    def generateChat(lengthLimit:Int, gram:Map[List[A],List[A]]):List[A] = {
...
object NGram {
    ...
    def apply[A](trainingData:List[List[A]], order:Int) = new NGram(trainingData, order)
